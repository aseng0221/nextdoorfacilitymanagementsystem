...
import { bookFacility, getFacilityBookingsByDate } from '../services/bookingService';
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity
          style={[
            ...
            (selectedStartHour === null || isBooking) && styles.confirmButtonDisabled
          ]}
          onPress={handleConfirmBooking}
          disabled={selectedStartHour === null || isBooking}
        >
